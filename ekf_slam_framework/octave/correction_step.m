...
for i = 1:m
  ...
  F = [[eye(3); zeros(2, 3)], zeros(5, 2*landmarkId - 2), [zeros(3, 2); eye(2)], ...
        zeros(5, (2*size(observedLandmarks, 2)) - (2*landmarkId))];
  Hi = (1/q) * [-q_root*delta(1), -q_root*delta(2), 0, q_root*delta(1), q_root*delta(2);
